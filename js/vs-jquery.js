...
$( document ).ready(function() { new_game501(); });
...
$('#new_game301').click( function () {
  new_game301();
});

$('#new_game501').click( function () {
  new_game501();
});
...
$('.gamer').click( function () {
  if (oneOfThree > 1 ){	//Если был хотя бы один бросок
   ...
   $('#bull'   + $(this).attr('id').slice(1)).html(parseInt($('#bull'   + $(this).attr('id').slice(1)).html()) + bull);
    ...
    if (parseInt($('#scre1').html()) === 0){$('#scre1').css('background-color', 'yellow');}
